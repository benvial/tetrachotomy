...
def refine_pole(
    ...
    while nref < nref_max and (
        ...
        if plot_circ:
            ...
            circ = trace_circ(
                plt.gca(), zp, r, fill=True, linewidth=0, facecolor=plotcolors[0], alpha=0.2
            )
...
def pole_hunt(
    ...
    if plot_rect:
        trace_rect(
            plt.gca(), z0, z1, fill=True, linewidth=0, facecolor=plotcolors[0], alpha=0.2
        )
        trace_rect(plt.gca(), z0, z1, fill=False, linewidth=0.1, edgecolor=plotcolors[0])
        trace_rect(
            plt.gca(),
            z0,
            z1,
